...
impl Instant {
    pub fn now() -> Instant {
        // Other Apple platforms (iOS, watchOS, tvOS, visionOS) use
        // CLOCK_UPTIME_RAW for the same don't-advance-while-sleeping semantics
        // that mach_absolute_time() provides on macOS.
        #[cfg(target_vendor = "apple")]
